...
export function HabitsList({ date, onCompletedChanged }: IHabitsListProps) {
  ...
  return (
    <>
      <div className="mt-6 flex flex-col gap-3 max-h-[274px] overflow-y-auto p-1 scrollbar-thin scrollbar-thumb-zinc-600 scrollbar-track-zinc-800">
        {isLoading ? (
      ...
      {isDateInPast && (
        <span className="text-zinc-400 font-semibold mt-2">
